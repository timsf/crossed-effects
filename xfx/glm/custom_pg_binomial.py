...
def sample_posterior(
    ...
    while True:
        _, yr1, yr2 = xfx.lm.gibbs.reduce_data(y - n / 2, np.zeros_like(y), nu, i)
        alp = xfx.lm.gibbs.update_coefs(yr1, yr2, None if collapse else alp0, alp, tau0, tau, 1, ome)
        ...
        nu = update_latent(n, alp0 + sum([alp_[i_] for alp_, i_ in zip(alp, i.T)]), True, ome)
